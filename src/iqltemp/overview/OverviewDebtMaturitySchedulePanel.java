...
public class OverviewDebtMaturitySchedulePanel extends TablePanel implements
		ContainerListener {
...
private int orientation;
	...
	public OverviewDebtMaturitySchedulePanel() {
		this.addListener(this);
		// TODO Auto-generated constructor stub
		this._I_TablePanel();
	}
	
	public OverviewDebtMaturitySchedulePanel(int orientation){
	...
	public void onCreate(Container source) {
		...
		titleLabel.setText("DEBT MATURITY SCHEDULE");
