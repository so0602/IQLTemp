...
public class STORM extends ImageBundle {
   public STORM() {
      super("iqltemp.gen.images.STORM");
   ...
   protected STORM _D_STORM() {
      try {
         return this;
      } catch (Throwable _t_fini_0) {
         throw new VScriptRuntimeException("_D_STORM", _t_fini_0);
      }
   ...
   public STORM _STORM() {
      try {
         ...
         throw new VScriptRuntimeException("_STORM", _t_init_0);
      }
