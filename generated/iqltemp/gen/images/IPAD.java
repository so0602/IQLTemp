...
public class IPAD extends ImageBundle {
   public IPAD() {
      super("iqltemp.gen.images.IPAD");
   ...
   protected IPAD _D_IPAD() {
      try {
         return this;
      } catch (Throwable _t_fini_0) {
         throw new VScriptRuntimeException("_D_IPAD", _t_fini_0);
      }
   ...
   public IPAD _IPAD() {
      try {
         ...
         throw new VScriptRuntimeException("_IPAD", _t_init_0);
      }
