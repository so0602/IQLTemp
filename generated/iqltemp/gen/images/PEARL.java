...
public class PEARL extends ImageBundle {
   public PEARL() {
      super("iqltemp.gen.images.PEARL");
   ...
   protected PEARL _D_PEARL() {
      try {
         return this;
      } catch (Throwable _t_fini_0) {
         throw new VScriptRuntimeException("_D_PEARL", _t_fini_0);
      }
   ...
   public PEARL _PEARL() {
      try {
         ...
         throw new VScriptRuntimeException("_PEARL", _t_init_0);
      }
